...
AdCP wurde [im Oktober 2025 von **Brian O'Kelley** und **Scope3** als Industrie-Koalition gestartet](https://www.samba.tv/press-releases/industry-coalition-launches-ad-context-protocol-adcp-open-standard-for-agentic-advertising-infrastructure). O'Kelley ist AppNexus-Mitgründer und heute Scope3-CEO — das gibt der Initiative Glaubwürdigkeit. Die Mitgliederliste sagt aber mehr über die Kräfteverhältnisse als jedes Manifest.
...
Die grossen Publisher fehlen in beiden Lagern — WBD, Disney, NBCU, News Corp sind nirgends Member. Ihr Bestandsgeschäft trägt sie auch ohne neuen Standard durch: Direktbeziehungen, Reichweite, Markenmacht. Der Druck ist nicht existenziell. Trade Desk wiederum ist Sonderfall: bei keinem von beiden. TTD will lieber Plattform sein als unabhängige AdTech, beide Lager passen nur halb. Dazu kam im März 2026 der [Publicis-Schock — nach einem FirmDecisions-Audit Buchungs-Stop](https://adage.com/agencies/aa-publicis-stops-recommending-the-trade-desk-after-audit/), die Aktie minus 33 Prozent seit Jahresbeginn. Drei der sechs grossen Holding Groups draussen; für Standards-Politik bleibt da kein Kopf.
...
![Drei Pipes im Vergleich. OpenRTB (heute) hat zwei Margen-Stationen: an DSP und SSP. AAMP behält die gleiche Pipe und ergänzt eine Agent-Schicht an beiden Enden — die Margen-Stationen bleiben unverändert. AdCP setzt auf eine Direktverbindung zwischen Buyer-Agent und Seller-Agent, beide Margen-Stationen entfallen.](/images/perspektiven/maschinen-werbemaschine-pipes.svg)

## Sieben Monate AdCP — drei Prototypen

AdCP ist seit Oktober 2025 öffentlich. Sieben Monate später, im Mai 2026, sind weltweit drei dokumentierte Cases mit Endkunden-Brand zu finden — alle in den USA. [CNN baut eine eigene In-House-Infrastruktur und peilt den vollen Trading-Mode für Q1 2027 an](https://digiday.com/media/cnn-builds-in-house-agent-infrastructure-as-it-prepares-for-ai-driven-media-trading/). [Warner Bros. Discovery fuhr im Dezember 2025 einen Seller-Agent-Test mit Magnite und Scope3](https://www.magnite.com/blog/why-magnite-built-a-seller-agent-and-what-it-signals-for-adcp/). Plus ein [erster vollautonomer AdCP-Lauf einer kanadischen Beverage-Brand mit PubMatic AgenticOS](https://www.marketingdive.com/news/beverage-marketer-sees-cost-savings-with-agentic-media-buying-test/814905/), ebenfalls Dezember 2025. Daneben [laufen Infrastruktur-Tests bei Magnite mit Disney Advertising und Publicis Media Exchange](https://www.magnite.com/press/magnite-unveils-new-ai-capabilities/) (April 2026), beide ohne Endkunden-Brand. Das sind Prototypen, keine Adoption. Und in einem Markt, in dem Modell-Releases im Zwei-Wochen-Takt kommen und ganze Tool-Schichten in einem Quartal entstehen, sind sieben Monate keine kurze Anlaufzeit. Sieben Monate sind hier eine Ewigkeit.

Im DACH-Markt ist die Lage entsprechend dünner: kein DACH-Akteur in der AdCP-Mitgliederliste, kein dokumentierter Pilot. Der [BVDW hat ein Lab "Agentic Media Buying" lanciert](https://www.bvdw.org/en/committees/programmatic-advertising-ecosystem/) — institutionelle Sondierung, kein Protokoll. Auf der [ADZINE CONNECT 26 im Februar 2026 lautete der Konsens "Evolution, kein Big Bang"](https://www.adzine.de/2026/03/adzine-connect-26-open-media-im-stresstest/).
